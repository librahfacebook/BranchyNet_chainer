...
MODEL_NAME = '../models/alexnet_cifar10(' + str(TRAIN_NUM_EPOCHES) + ').bn'  # 保存模型名称
CSV_NAME = 'alexnet(' + str(TRAIN_NUM_EPOCHES) + ')'  # 输出文件名称
...
#                              output_path=SAVE_PATH, output_name='alexnet_gpu(' + str(TRAIN_NUM_EPOCHES) + ')')
# # 将结果保存为csv文件
